...
def test_directed_small():
    ...
    mn.visualize(image_name)
    mn.statistics()
    # dic = mn.extract_level_from_statistics()
    # print(dic)
...
def test_directed_small_attr():
    ...
    df = pd.read_csv(file_name)
    mn = MindNet(user_id= 1, df = df, directed = True)
    mn.visualize_attr(image_name, attr_dic = {0: "male", 1:"male", 2:"female", 3:"female", 4:"male", 5:"female"})
...
def test_directed_medium_attr():
    ...
    df = pd.read_csv(file_name)
    mn = MindNet(user_id= 1, df = df, directed = True)
    mn.visualize_attr(image_name, attr_dic = {0: 'male', 2: 'Walmart Bag', 3: 'male', 4: 'female', 5: 'Walmart Bag', 6: 'male', 7: 'female', 8: 'Walmart Bag', 10: 'female', 11: 'Walmart Bag', 12: 'male', 13: 'female', 14: 'Walmart Bag', 15: 'male', 16: 'female', 17: 'Walmart Bag', 18: 'male', 19: 'female', 21: 'male', 22: 'female', 23: 'Walmart Bag', 24: 'male'})
...
def test_undirected_medium_attr():
    ...
    df = pd.read_csv(file_name)
    mn = MindNet(user_id= 1, df = df, directed = False)
    mn.visualize_attr(image_name, attr_dic = {0: 'male', 2: 'Walmart Bag', 4: 'female', 5: 'Walmart Bag', 6: 'male', 7: 'female', 8: 'Walmart Bag', 9: 'male', 10: 'female', 11: 'Walmart Bag', 12: 'male', 13: 'female', 14: 'Walmart Bag', 15: 'male', 16: 'female', 17: 'Walmart Bag', 18: 'male', 19: 'female', 20: 'Walmart Bag', 22: 'female', 23: 'Walmart Bag', 24: 'male'})
